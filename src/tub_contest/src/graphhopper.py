...
import threading
import rospy
from tub_contest.srv import SetGraphhopperMap, SetGraphhopperMapResponse
from mac_ros_bridge.msg import Role,Position
...
class GraphhopperProcessHandler(object):
    ...
    def __init__(self, maps=[], initial_port=GRAPHHOPPER_DEFAULT_PORT):
        ...
        self._package_path = rospack.get_path("tub_contest")
